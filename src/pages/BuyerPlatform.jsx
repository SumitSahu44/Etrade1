...
import { 
  ...
  MapPin, FileText, ShoppingBag, Layers, Settings, Eye, Send, Lock, CheckCircle, Upload, ChevronRight, Briefcase
} from 'lucide-react';
          ...
          <div className="max-w-2xl mx-auto bg-white p-12 rounded-[3.5rem] shadow-2xl shadow-slate-200 border border-slate-100 animate-in fade-in zoom-in duration-500 text-center">
            ...
            <div className="space-y-6 text-left mb-10">
              <div className="space-y-2">
                <label className="text-[12px] font-black text-slate-600 uppercase  ml-1">Official Name</label>
                <input 
                  type="text" 
                  value={authData.name}
              ...
              <div className="space-y-2">
                <label className="text-[12px] font-black text-slate-600 uppercase  ml-1">Official Code</label>
                <input 
                  type="text" 
                  value={authData.code}
          ...
          <div className="animate-in slide-in-from-bottom-10 duration-700 space-y-12">
            ...
            <div className="bg-emerald-500 text-white p-5 rounded-[2rem] flex items-center justify-between px-10 shadow-xl shadow-emerald-100">
              <div className="flex items-center gap-4">
                <CheckCircle size={24} />
                <p className="text-[11px] font-black uppercase ">Verified Associate: {authData.name} | ID: {authData.code}</p>
              </div>
              <span className="text-[12px] font-bold opacity-80 uppercase ">Session Active</span>
            </div>
            ...
            <form className="space-y-12">
              ...
              <div className="bg-white p-10 md:p-14 rounded-[3.5rem] shadow-sm border border-slate-100 space-y-10">
                <div className="flex justify-between items-center border-b border-slate-50 pb-8">
                  <div>
                    ...
                    <h3 className="text-3xl font-black text-slate-900 uppercase">Business <span className="text-blue-600">Identity</span></h3>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <label className="text-[12px] font-black text-slate-600 uppercase ml-1 ">Name of the Buyer</label>
                      <div className="relative group">
                        ...
                        <input type="text" className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 outline-none transition-all font-bold text-slate-600" placeholder="Proprietor / Legal Name" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-[12px] font-black text-slate-600 uppercase ml-1 ">Title of the Business</label>
                      <div className="relative group">
                        ...
                        <input type="text" className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 outline-none transition-all font-bold text-slate-600" placeholder="Company Legal Name" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-2 space-y-2">
                    <label className="text-[12px] font-black text-slate-600 uppercase ml-1 ">Address of the Business</label>
                    <div className="relative group">
                      <MapPin className="absolute left-4 top-5 text-slate-300 group-focus-within:text-blue-600 transition-colors" size={18} />
                      <textarea className="w-full pl-12 pr-4 py-4 bg-slate-50 border-none rounded-2xl focus:bg-white focus:ring-4 focus:ring-blue-50 outline-none transition-all font-bold text-slate-600" rows="2" placeholder="Complete Registered Office Address"></textarea>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-4">
                      <label className="text-[12px] font-black text-slate-600 uppercase  block">Membership in Chamber of Textile (If any)</label>
                      <textarea className="w-full p-6 bg-slate-50 border-none rounded-[2rem] focus:ring-2 focus:ring-blue-600 outline-none font-medium text-sm" rows="5" placeholder="Mention membership details..."></textarea>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-10 md:p-14 rounded-[3.5rem] shadow-sm border border-slate-100 space-y-10">
                <div className="border-b border-slate-50 pb-8">
                  ...
                  <h3 className="text-3xl font-black text-slate-900 uppercase">Textile Items <span className="text-blue-600">to Buy</span></h3>
                </div>

                <div className="space-y-8">
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    {['Textile Raw Materials', 'Textile Finished Products', 'Textile Industrial Machineries', 'Textile other Machineries', 'Textile Spares'].map((cat) => (
                      <div key={cat} className="p-4 bg-slate-50 border border-transparent rounded-2xl hover:border-blue-200 hover:bg-blue-50 cursor-pointer transition-all text-center flex items-center justify-center">
                        <p className="text-[12px] font-black text-slate-600 uppercase leading-tight">{cat}</p>
                      </div>
                    ))}
                  </div>

                  <div className="space-y-2">
                    <label className="text-[12px] font-black text-slate-600 uppercase  ml-1">Description of the items to buy</label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl">
                      <label className="text-[12px] font-black text-slate-600 uppercase block mb-2">Tentative Rate for Buying</label>
                      <input type="text" className="w-full bg-transparent border-b border-slate-200 py-2 outline-none font-bold text-xl" placeholder="₹ 0.00" />
                    </div>
                    <div className="bg-slate-50 p-6 rounded-2xl border-2 border-blue-100">
                      <label className="text-[12px] font-black text-blue-600 uppercase block mb-2">Tentative Budget for Buying</label>
